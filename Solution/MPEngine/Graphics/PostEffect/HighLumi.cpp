...
HighLumi* HighLumi::GetInstance() {
	static HighLumi instance;
	return &instance;
}

void HighLumi::CreatePipelineState() {
#pragma region Shader
	Microsoft::WRL::ComPtr<IDxcBlob> vertexShader;
	Microsoft::WRL::ComPtr<IDxcBlob> pixelShader;
	const std::string VSpath = "Fullscreen.VS.hlsl";
	const std::string PSpath = "HighLumi.PS.hlsl";
...
void HighLumi::DrawCommand(ID3D12GraphicsCommandList* comList, const uint32_t& handleNum) {
